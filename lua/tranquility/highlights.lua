...
local function set_lsp(colors, bg)
    ...
    hi('DiagnosticSignError', colors.error.light, bg)
    hi('DiagnosticSignWarning', colors.warning.light, bg)
    hi('DiagnosticSignInformation', colors.info.light, bg)
    hi('DiagnosticSignHint', colors.hint.light, bg)
    hi('DiagnosticUnderlineError', colors.error.light, bg, mod.underline)
    hi('DiagnosticUnderlineWarning', colors.warning.light, bg, mod.underline)
    hi('DiagnosticUnderlineInformation', colors.info.light, bg, mod.underline)
    hi('DiagnosticUnderlineHint', colors.hint.light, bg, mod.underline)
