...
local function set_native_syntax(colors)
    ...
    hi('Delimiter', { fg = colors.dark_yellow })
    hi('Error', { fg = colors.error })
    hi('Identifier', { fg = colors.light_white })
    hi('Ignore', { fg = colors.dark_white, italic = true })
    ...
    hi('Type', { fg = colors.light_white, bold = true })
    hi('Underlined', { fg = colors.light_white, underline = true })
...
local function set_visual_elements(colors)
    ...
    hi('Conceal', { fg = colors.light_black })
    hi('FloatBorder', { fg = colors.ui, bg = mod.none })
end

local function set_cmp(colors)
    hi('CmpItemAbbrMatch', { fg = colors.dark_yellow })
    hi('CmpItemAbbrMatchFuzzy', { fg = colors.dark_yellow })
    hi('CmpItemAbbrDeprecated', { fg = colors.light_white, strikethrough = true })
end
...
local function set_gitsigns(colors)
    hi('GitSignsAdd', { fg = colors.light_green })
    hi('GitSignsChange', { fg = colors.light_yellow })
    hi('GitSignsDelete', { fg = colors.light_red })
end

local function set_neovim(colors)
    hi('healthError', { fg = colors.light_black, bg = colors.error, bold = true })
    hi('healthSuccess', { fg = colors.light_black, bg = colors.green, bold = true })
    hi('healthWarning', { fg = colors.light_black, bg = colors.warning, bold = true })
end
...
local function set_treesitter(colors)
    ...
    hi('@function.call', { fg = colors.light_white, italic = true })
    ...
    hi('@label', 'Constant')
    hi('@method', '@variable')
    hi('@method.call', { fg = colors.light_white, italic = true })
    ...
    hi('@markup', { fg = colors.light_white })
    hi('@markup.italic', { fg = colors.light_white, italic = true })
    hi('@markup.link', { fg = colors.light_blue })
    hi('@markup.strikethrough', { fg = colors.dark_white })
    hi('@markup.strong', { fg = colors.light_white, bold = true })
...
local function set_lsp(colors)
    ...
    hi('DiagnosticUnderlineError', { fg = colors.error, bg = colors.light_black, underline = true })
    hi('DiagnosticUnderlineWarn', { fg = colors.warning, bg = colors.light_black, underline = true })
    hi('DiagnosticUnderlineInfo', { fg = colors.info, bg = colors.light_black, underline = true })
    hi('DiagnosticUnderlineHint', { fg = colors.hint, bg = colors.light_black, underline = true })
    hi('DiagnosticFloatingError', { fg = colors.error, bg = colors.light_black, italic = true })
    hi('DiagnosticFloatingWarn', { fg = colors.warning, bg = colors.light_black, italic = true })
    hi('DiagnosticFloatingInfo', { fg = colors.info, bg = colors.light_black, italic = true })
    hi('DiagnosticFloatingHint', { fg = colors.hint, bg = colors.light_black, italic = true })
...
local function set_gui(colors)
    ...
    hi('CursorColumn', { fg = mod.none, bg = colors.light_black })
    hi('CursorLine', 'CursorColumn')
    hi('Cursor', { fg = mod.none, bg = colors.ui_highlight })
    hi('CursorIM', 'Cursor')
    hi('lCursor', 'Cursor')
    hi('LineNr', { fg = colors.dark_white })
    hi('CursorLineNr', { fg = colors.ui })
    hi('SignColumn', { fg = mod.none })

    -- visual
    hi('Visual', { fg = mod.none, bg = colors.light_black, bold = true })
    hi('VisualNOS', { fg = mod.none, bg = colors.light_black, bold = true })
    ...
    hi('MatchParen', { fg = colors.operator, bg = colors.light_black, bold = true })

    -- diagnostics
    hi('SpellBad', { fg = colors.warning, bg = colors.light_black, underline = true })
    hi('SpellCap', 'SpellBad')
    hi('SpellLocal', 'SpellBad')
    hi('SpellRare', 'SpellBad')

    -- diff
    hi('DiffAdd', { fg = colors.light_black, bg = colors.light_green })
    hi('DiffChange', { fg = colors.light_black, bg = colors.light_yellow })
    hi('DiffDelete', { fg = colors.light_black, bg = colors.light_red })
    hi('DiffText', 'Normal')
...
local function set_highlights(colors)
    hi('Normal', { fg = colors.light_white, bg = colors.bg })
