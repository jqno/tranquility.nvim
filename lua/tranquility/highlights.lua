...
local function set_neovim(colors)
    hi('healthError', { fg = colors.highlighted_background, bg = colors.error })
    hi('healthSuccess', { fg = colors.highlighted_background, bg = colors.green })
    hi('healthWarning', { fg = colors.highlighted_background, bg = colors.warning })
end
...
local function set_treesitter(colors)
    ...
    hi('@function.call', { fg = colors.identifier })
...
local function set_lsp(colors)
    ...
    hi('DiagnosticFloatingError', { fg = colors.error, bg = colors.ui_dim_background })
    hi('DiagnosticFloatingWarn', { fg = colors.warning, bg = colors.ui_dim_background })
    hi('DiagnosticFloatingInfo', { fg = colors.info, bg = colors.ui_dim_background })
    hi('DiagnosticFloatingHint', { fg = colors.hint, bg = colors.ui_dim_background })
...
local function set_filetype_markdown(colors)
    hi('@markup.quote.markdown', { fg = colors.comment })
...
local function set_gui(colors)
    ...
    hi('WarningMsg', { fg = colors.ui_background, bg = colors.warning })
    ...
    -- visual
    hi('Visual', { fg = colors.identifier, bg = colors.visual })
    hi('VisualNOS', 'Visual')
